...
1. Ensure you have [Python](https://www.python.org/) installed.
   ...
   ```bash
    pip install git+https://github.com/MrCode200/repo_name.git   
   ```
   ```bash
...
- To view documentation in your website click [here](https://raw.githack.com/MrCode200/repo_name/refs/heads/main/docs/html/index.html).
...
- [contributer_github_user_name](https://github.com/username) [what he did]
...
- **Your Name** - [email@gmail.com](mailto:email@gmail.com)
- **Project Link** - [https://github.com/MrCode200/repo_name](https://github.com/MrCode200/repo_name)
